...
def draw_screen(data):
    ...
    note3 = re.sub('\r','\n',data[5]).strip()
    note4 = re.sub('\r','\n',data[7]).strip()
    pygame.draw.circle(screen, 'white', (575, (60000 / float(note1)) if float(note1) > 0 else 0), 20)
    pygame.draw.circle(screen, 'white', (675, (60000 / float(note2)) if float(note2) > 0 else 0), 20)
    pygame.draw.circle(screen, 'white', (775, (60000 / float(note3)) if float(note3) > 0 else 0), 20)
    pygame.draw.circle(screen, 'white', (875, (60000 / float(note4)) if float(note4) > 0 else 0), 20)
